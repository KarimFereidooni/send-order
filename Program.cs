namespace SendOrder
{
    ...
    internal static class Program
    {
        ...
        internal static void Main(string[] args)
        {
            ...
            // string orderPayload = JsonConvert.SerializeObject(Data.Instance.Order);
            ...
            Thread orderThread = new Thread(new ThreadStart(() =>
            {
                ...
                do
                {
                    try
                    {
                        ...
                        {
                            httpClient.PostAsync(Data.Instance.Url, orderContent);
                        }
        ...
        private static HttpClient GetHttpClient()
        {
            ...
            client.DefaultRequestHeaders.Add("Host", "onlineplus.bmibourse.com");
            ...
            client.DefaultRequestHeaders.Add("Origin", "https://onlineplus.bmibourse.com");
            client.DefaultRequestHeaders.Add("Sec-Fetch-Site", "same-origin");
            client.DefaultRequestHeaders.Add("Sec-Fetch-Mode", "cors");
            client.DefaultRequestHeaders.Add("Referer", "https://onlineplus.bmibourse.com/Home/Default/page-1");
